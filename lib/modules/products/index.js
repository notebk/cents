...
module.exports = {
  ...
  addFields: [
    ...
    {
      name: '_specialists', //underscore is to not record specialist inside the product within the database. the underscore says it's dynamic.
      type: 'joinByArray', //pick more than one specialist
      withType: 'specialist', //join with the type specialist
      label: 'Specialists', 
      help: 'The right people to ask about this product.'
    }
  ],

  construct: function(self, options) { //a function inside which you can attach methods to your module
      //takes self as argument, self's value is changing -- self is always the module
